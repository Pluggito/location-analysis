              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setShowZoningDescription(!showZoningDescription)
                    }
                    className="h-6 w-6 p-0"
                  >
                ...
                {showZoningDescription && (
                  <div className="bg-gray-50 p-2 rounded text-xs">
                    <p className="text-gray-700">
                      M3-1 districts are intended for heavy manufacturing and
                      industrial uses. They allow a wide range of manufacturing,
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setShowKeyLocationOverlay(!showKeyLocationOverlay)
                    }
                    className="h-5 w-8 p-0"
                  >
                    {showKeyLocationOverlay ? (
...
export default function ZoningMap({
  ...
  const onEachCommercial = (feature: any, layer: any) => {
    ...
    layer.bindTooltip(`Overlay: ${OVERLAY}`, {
      sticky: true,
      direction: "top",
      offset: [0, -10],
    });
  ...
  // Removed duplicate setShowPortOverlay function to resolve identifier conflict
                ...
                <div>
                  {commercialData && (
                    <GeoJSON
                      ...
                      onEachFeature={onEachCommercial}
                    />
                  )}

                  {specialDistrictData && (
                    <GeoJSON
                      data={specialDistrictData}
                      style={specialStyle}
                      onEachFeature={onEachSpecial}
                    />
                  )}

                  {limitedHeightData && (
                    <GeoJSON
                      data={limitedHeightData}
                      style={lhStyle}
                      onEachFeature={onEachLH}
                    />
                  )}
                </div>
              )}
